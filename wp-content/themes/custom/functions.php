...
function patronus_func($atts) {
    return '<div id="app"></div><script src="' . 
        get_template_directory_uri() . 
        '/patronus/dist/bundle.js"></script>';
}
...
function create_patronus_type() {
  register_post_type( 'patronus',
    array(
        'labels' => array(
            'name' => __( 'Patronuses' ),
            'singular_name' => __( 'Patronus Charm' ),
            'all_items' => 'All Patronus',
            'add_new' => 'Add New',
...
function json_api_encode_acf($response) 
{
    if (isset($response['posts'])) {
        foreach ($response['posts'] as $post) {
            // Add specs to each post
            json_api_add_acf($post); 
        }
    } 
    else if (isset($response['post'])) {
        // Add a specs property
